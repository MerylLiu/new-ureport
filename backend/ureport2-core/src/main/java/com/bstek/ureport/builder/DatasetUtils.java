 ...
 * the License.
 ******************************************************************************/
package com.bstek.ureport.builder;

import java.util.HashMap;
import java.util.List;
import java.util.Map;

import com.bstek.ureport.builder.aggregate.Aggregate;
import com.bstek.ureport.builder.aggregate.AvgAggregate;
import com.bstek.ureport.builder.aggregate.CountAggregate;
import com.bstek.ureport.builder.aggregate.CustomGroupAggregate;
import com.bstek.ureport.builder.aggregate.GroupAggregate;
import com.bstek.ureport.builder.aggregate.MaxAggregate;
import com.bstek.ureport.builder.aggregate.MinAggregate;
import com.bstek.ureport.builder.aggregate.RegroupAggregate;
import com.bstek.ureport.builder.aggregate.ReselectAggregate;
import com.bstek.ureport.builder.aggregate.SelectAggregate;
import com.bstek.ureport.builder.aggregate.SumAggregate;
